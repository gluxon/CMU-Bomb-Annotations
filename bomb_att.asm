...
08048b98 <phase_3>:
 ...
 8048b9b:	83 ec 14             	sub    $0x14,%esp
                                ...
                                // save ebx callee-save register
 8048b9e:	53                   	push   %ebx

                                // save phase_3 argument (input string) to edx
 8048b9f:	8b 55 08             	mov    0x8(%ebp),%edx

                                // ??????? byte aligning?
 8048ba2:	83 c4 f4             	add    $0xfffffff4,%esp

                                // sscanf argument #5: pointer to last %d
 8048ba5:	8d 45 fc             	lea    -0x4(%ebp),%eax
 8048ba8:	50                   	push   %eax

                                // sscanf argument #4: pointer to %c
 8048ba9:	8d 45 fb             	lea    -0x5(%ebp),%eax
 8048bac:	50                   	push   %eax

                                // sscanf argument #3: pointer to first %d
 8048bad:	8d 45 f4             	lea    -0xc(%ebp),%eax
 8048bb0:	50                   	push   %eax

                                // sscanf argument #2: "%d %c %d"
 8048bb1:	68 de 97 04 08       	push   $0x80497de

                                // sscanf argument #1: input string
 8048bb6:	52                   	push   %edx
 ...
 8048bc4:	e8 33 09 00 00       	call   80494fc <explode_bomb>
                                ...
                                // if token#1 is above 7, explode
 8048bc9:	83 7d f4 07          	cmpl   $0x7,-0xc(%ebp)
 8048bcd:	0f 87 b5 00 00 00    	ja     8048c88 <phase_3+0xf0> // exploding address

                                // Jump puzzle?
 8048bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax // move token#1 into eax
                                // 0x80497e8 dereferences to 0x8048be0
 8048bd6:	ff 24 85 e8 97 04 08 	jmp    *0x80497e8(,%eax,4) // Jump 0x8048be0 + token#1 bytes

 8048bdd:	8d 76 00             	lea    0x0(%esi),%esi // pointless NOP?
...
08048ca0 <func4>:
 ...
 8048ca8:	8b 5d 08             	mov    0x8(%ebp),%ebx
                                ...
                                // if input is less than or equal to 1, return 1.
 ...
 8048cb0:	83 c4 f4             	add    $0xfffffff4,%esp
                                ...
                                // subtract 1 from the input and recursively call func4
 8048cb3:	8d 43 ff             	lea    -0x1(%ebx),%eax
 8048cb6:	50                   	push   %eax
 8048cb7:	e8 e4 ff ff ff       	call   8048ca0 <func4>

                                // store recursive return in esi.
 8048cbc:	89 c6                	mov    %eax,%esi

 8048cbe:	83 c4 f4             	add    $0xfffffff4,%esp

                                // subtract 2 from the input and recursively call 4
 8048cc1:	8d 43 fe             	lea    -0x2(%ebx),%eax
 8048cc4:	50                   	push   %eax
 8048cc5:	e8 d6 ff ff ff       	call   8048ca0 <func4>

                                // return the first return plus the second return
 8048cca:	01 f0                	add    %esi,%eax
 8048ccc:	eb 07                	jmp    8048cd5 <func4+0x35> // win?

                                // wait a minute, this is the fibonacci sequence!!!
...
08048ce0 <phase_4>:
 ...
 8048ce3:	83 ec 18             	sub    $0x18,%esp
                                ...
                                // Move source string into edx
 8048ce6:	8b 55 08             	mov    0x8(%ebp),%edx

                                // Subtract 3 from esp. Why? IDK...
 8048ce9:	83 c4 fc             	add    $0xfffffffc,%esp

                                // sscanf return argument
 ...
 8048cfb:	83 c4 10             	add    $0x10,%esp
                                ...
                                // explode bomb if input is not 1 decimal integer
 8048cfe:	83 f8 01             	cmp    $0x1,%eax
 8048d01:	75 06                	jne    8048d09 <phase_4+0x29>

                                // explode if input is 0 or less
...
08048d2c <phase_5>:
 ...
 8048d4f:	8d 4d f8             	lea    -0x8(%ebp),%ecx
                                ...
                                // isrveawhobpnutfg\260\001
 8048d52:	be 20 b2 04 08       	mov    $0x804b220,%esi

                                // move input[0] into al
 8048d57:	8a 04 1a             	mov    (%edx,%ebx,1),%al

                                // Clear the top half of input[0]. If it is greater than 15, make it 15.
 8048d5a:	24 0f                	and    $0xf,%al

                                // eax = al
 8048d5c:	0f be c0             	movsbl %al,%eax

                                // move the eax'th character into al
 8048d5f:	8a 04 30             	mov    (%eax,%esi,1),%al

                                // store characters at ecx to create a string
 ...
 8048d80:	83 c4 10             	add    $0x10,%esp
                                ...
                                // explode if eax is not 0. (If the strings are not equal)
...
08048d98 <phase_6>:
 ...
 8048da1:	8b 55 08             	mov    0x8(%ebp),%edx
                                ...
                                // The first element of a linked list exists at 0x804b26c
 8048da4:	c7 45 cc 6c b2 04 08 	movl   $0x804b26c,-0x34(%ebp)

                                // useless padding
 8048dab:	83 c4 f8             	add    $0xfffffff8,%esp

                                // second argument of read_six_numbers, write 6 numbers to this location
 8048dae:	8d 45 e8             	lea    -0x18(%ebp),%eax
 8048db1:	50                   	push   %eax

                                // call read_six_numbers with our input string
 8048db2:	52                   	push   %edx
 ...
 8048dbd:	8d 76 00             	lea    0x0(%esi),%esi
                               ...
                               // while edi < 6 {
                                  ...
                                  // eax points to the 6 numbers
   8048dc0:	8d 45 e8             	lea    -0x18(%ebp),%eax

                                  // move the next number into eax. This is to loop through all numbers.
   8048dc3:	8b 04 b8             	mov    (%eax,%edi,4),%eax

                                  // take the number and subtract 1
   8048dc6:	48                   	dec    %eax

                                  // If that number is above 5, explode
                                  // So it looks like all 6 numbers should be from 1-6
   ...
   8048dd1:	8d 5f 01             	lea    0x1(%edi),%ebx
                                  ...
                                  // if ebx is greater than 5, break out of this loop
                                  // We can break since the loop below is to ensure all the numbers are unique.
                                  // After checking the 5th number, it should be fine. No need to check 6th
   8048dd4:	83 fb 05             	cmp    $0x5,%ebx
   8048dd7:	7f 23                	jg     8048dfc <phase_6+0x64>

                                  // store 6 number array index into ebp-0x38
   8048dd9:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax
   8048de0:	89 45 c8             	mov    %eax,-0x38(%ebp)

                                  // point esi at the 6 numbers
   8048de3:	8d 75 e8             	lea    -0x18(%ebp),%esi
     ...
     8048de9:	8b 04 32             	mov    (%edx,%esi,1),%eax
                                    ...
                                    // explode if two numbers are equal
 ...
 //8048e0d:	8d 76 00             	lea    0x0(%esi),%esi
   ...
   8048e13:	bb 01 00 00 00       	mov    $0x1,%ebx
                                  ...
                                  // edx and eax = edi * 4, edx/eax will be the byte offset of the number array index
   8048e18:	8d 04 bd 00 00 00 00 	lea    0x0(,%edi,4),%eax
   8048e1f:	89 c2                	mov    %eax,%edx

                                  // if (input[i] <= 1) continue
   8048e21:	3b 1c 08             	cmp    (%eax,%ecx,1),%ebx
   8048e24:	7d 12                	jge    8048e38 <phase_6+0xa0> // this seems to be a "continue" in a for loop
   ...
   //8048e29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
                                  ...
                                  // while ebx < eax {
     8048e30:	8b 76 08             	mov    0x8(%esi),%esi // traverse through elements in linked list
     8048e33:	43                   	inc    %ebx
                                  // } // while ebx < eax
   ...
   8048e38:	8b 55 c4             	mov    -0x3c(%ebp),%edx
                                  // store pointers to linked list items at ebp-0x30
...
// 0x804b230:	0x000001b0	0x00000006	0x00000000   = 432
 ...
 8048e44:	8b 75 d0             	mov    -0x30(%ebp),%esi
                                ...
                                // store that pointer to array of leaf references in ebp-0x34
